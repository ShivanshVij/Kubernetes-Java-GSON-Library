...
**updateStrategy** | [**IoK8sApiAppsV1beta2DaemonSetUpdateStrategy**](IoK8sApiAppsV1beta2DaemonSetUpdateStrategy.md) | An update strategy to replace existing DaemonSet pods with new pods. |  [optional]
