...
**rollbackTo** | [**IoK8sApiExtensionsV1beta1RollbackConfig**](IoK8sApiExtensionsV1beta1RollbackConfig.md) | DEPRECATED. The config this deployment is rolling back to. Will be cleared after rollback is done. |  [optional]
