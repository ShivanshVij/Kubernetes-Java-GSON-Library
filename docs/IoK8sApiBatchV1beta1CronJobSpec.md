...
**jobTemplate** | [**IoK8sApiBatchV1beta1JobTemplateSpec**](IoK8sApiBatchV1beta1JobTemplateSpec.md) | Specifies the job that will be created when executing a CronJob. | 
