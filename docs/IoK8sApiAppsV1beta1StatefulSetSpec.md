...
**updateStrategy** | [**IoK8sApiAppsV1beta1StatefulSetUpdateStrategy**](IoK8sApiAppsV1beta1StatefulSetUpdateStrategy.md) | updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template. |  [optional]
