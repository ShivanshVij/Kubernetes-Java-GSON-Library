...
public class AuthenticationV1beta1Api {
     ...
     */
    public com.squareup.okhttp.Call createAuthenticationV1beta1TokenReviewCall(IoK8sApiAuthenticationV1beta1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createAuthenticationV1beta1TokenReviewValidateBeforeCall(IoK8sApiAuthenticationV1beta1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createAuthenticationV1beta1TokenReviewCall(body, dryRun, includeUninitialized, pretty, progressListener, progressRequestListener);
        return call;
     ...
     */
    public IoK8sApiAuthenticationV1beta1TokenReview createAuthenticationV1beta1TokenReview(IoK8sApiAuthenticationV1beta1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty) throws ApiException {
        ApiResponse<IoK8sApiAuthenticationV1beta1TokenReview> resp = createAuthenticationV1beta1TokenReviewWithHttpInfo(body, dryRun, includeUninitialized, pretty);
        return resp.getData();
    }
     ...
     * @param includeUninitialized If IncludeUninitialized is specified, the object may be returned without completing initialization. (optional)
     * @param pretty If &#39;true&#39;, then the output is pretty printed. (optional)
     * @return ApiResponse&lt;IoK8sApiAuthenticationV1beta1TokenReview&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<IoK8sApiAuthenticationV1beta1TokenReview> createAuthenticationV1beta1TokenReviewWithHttpInfo(IoK8sApiAuthenticationV1beta1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty) throws ApiException {
        com.squareup.okhttp.Call call = createAuthenticationV1beta1TokenReviewValidateBeforeCall(body, dryRun, includeUninitialized, pretty, null, null);
        Type localVarReturnType = new TypeToken<IoK8sApiAuthenticationV1beta1TokenReview>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call createAuthenticationV1beta1TokenReviewAsync(IoK8sApiAuthenticationV1beta1TokenReview body, String dryRun, Boolean includeUninitialized, String pretty, final ApiCallback<IoK8sApiAuthenticationV1beta1TokenReview> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createAuthenticationV1beta1TokenReviewValidateBeforeCall(body, dryRun, includeUninitialized, pretty, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<IoK8sApiAuthenticationV1beta1TokenReview>(){}.getType();
